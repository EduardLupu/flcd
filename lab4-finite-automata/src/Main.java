...
public class Main {
    ...
    private static void optionsForDFA() {
        ...
        FiniteAutomata finiteAutomata = new FiniteAutomata("Input_Output/FA.txt");
        ...
        while (option != 0) {
            ...
            switch (option) {
                ...
                case 4:
                    System.out.println(finiteAutomata.writeTransitions());
                    break;
                ...
                case 6:
                    ...
                    System.out.println(finiteAutomata.checkIfDeterministic());
                    break;
